...
@section('conteudo')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Cadastre seu nome,email e senha para criar uma nova conta!') }}</div>
                ...
                <div class="card-body">
                    <form method="POST"  action="{{route('register')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="senha" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" >
